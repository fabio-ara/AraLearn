...
select throws_ok($$select public.save_authoring_profile_for_actor_v1('93000000-0000-4000-8000-000000000001','93000000-0000-4000-8000-000000000201',0,'Perfil obsoleto','[{"parameterId":"practice_distribution","mode":"fixed","value":"clustered"}]','profile-stale-01',repeat('b',64))$$,'PT409',null,'perfil verifica CAS');
...
select is(public.get_owned_course_authoring_analytics_for_actor_v4('93000000-0000-4000-8000-000000000001','93000000-0000-4000-8000-000000000101',(select revision from public.courses where id='93000000-0000-4000-8000-000000000101'),' {"scope":{"kind":"course","ref":null}}')->>'contract','aralearn.course-authoring-analytics.v4','analytics consulta a sequência real no contrato novo');
