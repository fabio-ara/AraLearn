...
('99280000-0000-4000-8000-000000000101','study_unit','u1','microsequence','a',1,'{"title":"Observe a conexão","role":"theory","content":[{"id":"p","package":"aralearn.resource.paragraph","version":"1.0.0","data":{"text":"A ligação permite que os elementos interajam."}}],"response":null,"feedback":[],"topics":[]}'),
('99280000-0000-4000-8000-000000000101','study_unit','u2','microsequence','a',2,'{"title":"Compare situações","role":"theory","content":[{"id":"p","package":"aralearn.resource.paragraph","version":"1.0.0","data":{"text":"Compare retirar a ligação e mudar a cor. Qual mudança impede a interação?"}}],"response":null,"feedback":[],"topics":[]}');
...
select public.set_course_content_review_v1('99280000-0000-4000-8000-000000000101','microsequence_explanation','a',private.course_content_basis_hash_v1('99280000-0000-4000-8000-000000000101','microsequence_explanation','a'),true,'manual-review-simulated');
...
select is(private.course_content_review_v1('99280000-0000-4000-8000-000000000101','microsequence_explanation','a')->>'state','stale','alteração material torna aprovação anterior não atual');
