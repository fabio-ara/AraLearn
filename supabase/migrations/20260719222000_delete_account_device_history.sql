...
begin
  ...
  -- sync_mutations referencia sync_devices com RESTRICT. A ordem explícita
  -- evita depender da ordem interna dos cascades ao remover auth.users.
  delete from public.sync_mutations mutation
  where mutation.user_id = v_user_id;
  delete from public.sync_devices device
