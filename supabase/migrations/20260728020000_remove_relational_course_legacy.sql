  ...
  for v_function in
    ...
    where n.nspname in ('public', 'private')
      and (
        ...
        or p.proname like '%official_course_import%'
        or p.proname like '%course_content_revision%'
        or p.proname like '%personal_course_creation%'
        or p.proname like '%personal_course%'
        or p.proname in (
          'authoring_assert_staging_quota',
          'authoring_compact_terminal_payloads',
          'authoring_complete_publication',
          'apply_one_sync_mutation',
          'apply_official_course_import_chunk',
          'apply_official_stage_row',
          'apply_personal_tree_sync_mutation',
          'assert_formula_block_ast',
          'authoring_actor_retained_bytes',
          'authoring_assert_private_identity',
          'authoring_clear_private_stage_after_compaction',
          'authoring_enforce_import_staging_quota',
          'authoring_learning_continuity',
          'authoring_run_is_accessible',
          'authoring_run_staging_bytes',
          'begin_official_course_import',
          'begin_official_course_import_flow',
          'cleanup_abandoned_official_imports',
          'clone_course_tree',
          'content_row_card_id',
          'content_row_microsequence_id',
          'course_content_hash',
          'course_revision_document_rows',
          'course_revision_entity_ids',
          'course_revision_fragment_rows',
          'course_revision_store_rows',
          'finalize_official_course_import',
          'fragment_entity_microsequence_id',
          'guard_learning_component_placement',
          'guard_learning_requires_cycle',
          'learning_component_continuity',
          'list_catalog_courses',
          'mark_course_content_dirty',
          'materialize_authoring_learning_metadata',
          'materialize_learning_metadata_before_compaction',
          'personal_tree_payload_key_allowed',
          'prepare_official_course_replacement',
          'reconcile_official_course_progress',
          'refresh_matrix_dimensions',
          'replace_microsequence_cards',
          'release_empty_official_import_staging',
          'remap_stale_personal_state_mutation',
          'resolve_private_course_revision_target',
          'soft_delete_course_tree',
          'soft_delete_microsequence_cards',
          'sync_storage_diagnostics',
          'sync_payload_key_allowed',
          'table_for_store',
          'validate_microsequence_fragment_scope',
