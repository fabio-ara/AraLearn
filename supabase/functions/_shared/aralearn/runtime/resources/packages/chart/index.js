...
export const chartPackage = Object.freeze({
  manifest: Object.freeze({ id: "aralearn.resource.chart", version: "1.0.0", label: "Gráfico estatístico", purpose: "Tornar tendência, distribuição ou comparação quantitativa visualmente observável.", slots: Object.freeze(["content", "feedback"]), cognitiveOperations: Object.freeze(["compare-quantity", "identify-trend", "inspect-distribution", "find-outlier"]), responseCompatibility: Object.freeze(["aralearn.response.gap", "aralearn.response.choice"]), limitations: Object.freeze(["Eixos, unidade e escala precisam ser declarados.", "Não use para poucos valores melhor explicados em prosa." ]), accessibility: "Séries e valores são repetidos em descrição textual."
  }),
  authoringContract: Object.freeze({ intent: "Declare eixos e séries; o motor deriva escala e marcas.", required: Object.freeze(["chartType", "xAxis", "yAxis", "series"]), optional: Object.freeze(["prompt"]), rules: Object.freeze(["Unidades não ficam implícitas.", "Compare apenas séries semanticamente compatíveis."]), example: Object.freeze({ prompt: "Observe o crescimento.", chartType: "line", xAxis: { label: "Tempo" }, yAxis: { label: "Valor", unit: "ms" }, series: [{ id: "s1", name: "Latência", values: [["1", 10], ["2", 18], ["3", 25]] }] }) }),
