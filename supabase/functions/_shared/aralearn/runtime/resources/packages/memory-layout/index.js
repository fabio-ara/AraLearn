...
export const memoryLayoutPackage = Object.freeze({
  manifest: Object.freeze({ id: "aralearn.resource.memory_layout", version: "1.0.0", label: "Mapa de memória", purpose: "Representar intervalos de endereços, segmentos e ocupação de memória na ordem convencional.", slots: Object.freeze(["content", "feedback"]), cognitiveOperations: Object.freeze(["locate-address", "calculate-range", "inspect-allocation", "trace-stack"]), academic: academicProfile({ domains: ["organização de computadores", "sistemas operacionais", "programação de baixo nível"], knowledgeObjects: ["endereço", "segmento de memória", "pilha", "heap", "quadro de ativação"], conventions: ["endereços nas extremidades", "ordem crescente ou decrescente declarada", "intervalos contíguos", "papel do segmento nomeado"], appropriateWhen: ["posição e intervalo de memória participam do raciocínio"], avoidWhen: ["a tarefa exige somente listar variáveis", "a estrutura é uma pilha lógica sem endereços"], technologies: ["HTML semântico", "CSS grid"], practiceModes: ["exposition", "gap", "typing", "selection", "ordering"] }), responseCompatibility: Object.freeze(["aralearn.response.gap", "aralearn.response.choice"]), limitations: Object.freeze(["Endereços precisam usar a mesma base.", "Layouts muito extensos devem focar somente os intervalos relevantes."]), accessibility: "Segmentos são lidos na ordem dos endereços com início, fim, rótulo e descrição." }),
  authoringContract: Object.freeze({ intent: "Declare intervalos ordenados e a direção dos endereços; não use table para simular o desenho de memória.", required: Object.freeze(["addressOrder", "segments"]), optional: Object.freeze(["prompt", "addressBase"]), rules: Object.freeze(["start e end seguem a base declarada.", "Intervalos não se sobrepõem.", "A ordem visual deriva dos endereços."]), example: Object.freeze({ prompt: "Observe as regiões de um processo.", addressOrder: "ascending", addressBase: "hexadecimal", segments: [{ id: "text", start: "0x00400000", end: "0x0040FFFF", label: "Código", kind: "code", description: "Instruções executáveis" }, { id: "heap", start: "0x00600000", end: "0x0060FFFF", label: "Heap", kind: "heap", description: "Alocação dinâmica" }] }) }),
