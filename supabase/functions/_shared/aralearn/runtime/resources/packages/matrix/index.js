...
export const matrixPackage = Object.freeze({
  ...
  authoringContract: Object.freeze({ intent: "Declare values ou sequence de matrizes, sem coordenadas visuais.", required: Object.freeze([]), optional: Object.freeze(["prompt", "name", "values", "sequence"]), rules: Object.freeze(["Use exatamente values ou sequence.", "Linhas têm o mesmo comprimento."]), example: Object.freeze({ prompt: "Observe a identidade.", name: "I", values: [["1", "0"], ["0", "1"]] }) }),
