...
export const AUTHORING_APPLICATION_ONLY_TOOLS = Object.freeze([
  EXPERIMENT_APPLICATION_TOOL,
  EXPERIMENT_ENROLLMENT_TOOL,
  ANALYTICS_APPLICATION_TOOL
]);
const APPLICATION_ONLY_TOOL_BY_NAME = new Map(
  AUTHORING_APPLICATION_ONLY_TOOLS.map((definition) => [definition.name, definition])
);
