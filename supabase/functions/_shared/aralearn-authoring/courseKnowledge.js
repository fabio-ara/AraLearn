...
export const COURSE_AUTHORING_SERVER_INSTRUCTIONS = [
  ...
  "Retome o contexto. Preserve fixações da autoria e pesquisa; em automático, escolha valor e motivo. Foco Conteúdo desenvolve explicação e fontes antes das unidades. Cadência, revisão e diálogo são independentes. Parte é lote operacional. Ensine dependências antes do uso. Salvar não revisa; revisão pendente permite produção e estudo. Curso público exige definir_visibilidade e releitura antes do sucesso; arquivos disponíveis salvo restrição explícita. Devolva resultado breve, link exato em Markdown e próxima etapa no mandato."
].join("\n");
