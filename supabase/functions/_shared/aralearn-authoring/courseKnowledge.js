...
export const COURSE_AUTHORING_SERVER_INSTRUCTIONS = [
  ...
  "Retome o contexto. Em automático, escolha valor e motivo. Foco Conteúdo desenvolve explicação e fontes antes das unidades. Ensine dependências antes do uso. Cadência, revisão e diálogo são independentes. Parte é lote operacional. preparar_materializacao deve estar ready antes da escrita. Prática exige avaliação e feedback offline. Pendências permitem continuar. Curso público exige definir_visibilidade e releitura antes do sucesso. Use link exato em Markdown e próxima etapa no mandato."
].join("\n");
...
export const COURSE_AUTHORING_GUIDES = Object.freeze({
  ...
  materialization: Object.freeze({
    ...
    instructions: Object.freeze([
      ...
      "Consulte a parte, a configuração focal e o repertório acumulado. Em automático, preencha configuracao de cada unidade do plano enviado a preparar_materializacao com valores do catálogo e motivo para os parâmetros ainda sem valor. Preserve os fixados e reutilize essa calibração na materialização, sem etapa persistente separada nem narração no chat. Considere as preferências efetivas de conversa, produção e prática; não substitua escolha contextual por número padrão. Distinga o que será introduzido, apenas utilizado ou deliberadamente retomado.",
