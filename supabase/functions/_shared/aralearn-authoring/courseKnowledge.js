...
export const COURSE_AUTHORING_SERVER_INSTRUCTIONS = [
  "O AraLearn mantém um Curso vivo e mutável como única autoridade. Planeje uma Parte por vez. Cada AnalysisUnit é novidade material independente, inclusive fundamento ainda não estabelecido; preserve o inventário e crie quantas StudyUnits forem necessárias. Leia planejamento e configuração focal antes de decidir ou materializar. Antes de escrever, apresente a mudança concreta e obtenha uma única decisão. Responda só com resultado, deep link e no máximo uma próxima decisão.",
  "Escolha tarefas por ‘Use’/‘Não use’ e localize objetos por referências humanas.",
  "Depois da decisão, aplique e releia sem confirmações mecânicas; não repita no chat conteúdo já aberto no AraLearn.",
  "Antes de materializar, leia com consultar_componentes o contrato exato de cada componente escolhido.",
  "Peça uma referência mais específica somente diante de ambiguidade real.",
...
export const COURSE_AUTHORING_GUIDES = Object.freeze({
  planning_design: Object.freeze({
    ...
    instructions: Object.freeze([
      ...
      "Antes de persistir cada statement, confronte-o: há mais de uma mudança independente que mereça acompanhamento próprio; algum termo tratado como prévio esconde novidade; o enunciado declara relação, propriedade ou condição rastreável ou apenas um tópico agregado? Se a pessoa precisa aprender dois conceitos novos e também a relação entre eles, há normalmente pelo menos três unidades de análise; inventarie inclusive os conceitos fundamentais ainda não estabelecidos. Decomponha indício forte e peça decisão humana somente na ambiguidade pedagógica real.",
  ...
  materialization: Object.freeze({
    ...
    instructions: Object.freeze([
      ...
      "Antes de gravar a candidata, compare cada conceito e relação que o texto realmente explica com o inventário. Se a pessoa precisa aprendê-lo e ele ainda não foi estabelecido, ele é novidade mesmo quando fundamental ou necessário apenas para alicerçar outra novidade; não o esconda no texto de uma AnalysisUnit mais larga. Um termo geral incidental não vira unidade de análise; se a falha for real, corrija o planejamento ou a candidata antes de continuar.",
      ...
      "Distribua prática e consolidação perto do menor bloco de novidades e pré-requisitos que já as torna compreensíveis, quando pedagogicamente possível; não deixe toda a prática para depois de uma longa sequência teórica. Preserve o mínimo e a variação da prática de evidência. Consolidação formativa sem finalidade de evidência usa Unidade de prática sem practiceApplications; não invente evidence_requirement.",
  ...
  components: Object.freeze({
    ...
    instructions: Object.freeze([
      ...
      "Na consulta, descreva a função e informe papel e lugar; quando conhecidos, preencha também estrutura e operação. Inclua na função os objetos de conhecimento e o que precisa ser preservado. Essas facetas e os metadados do catálogo orientam o encaixe; a adequação semântica final continua sendo julgamento do GPT ou da pessoa.",
