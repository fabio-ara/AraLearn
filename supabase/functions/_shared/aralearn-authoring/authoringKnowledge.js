...
const KNOWLEDGE_CHUNKS = Object.freeze([
  ...
  Object.freeze({
    ...
    text: "O mesmo assistente planeja, constrói, audita, repara e reaudita, mas não mistura essas etapas editoriais. Microssequência é a unidade técnica de gravação; parte é o recorte de coordenação e pode reunir várias microssequências ou lições. Depois de cada etapa, informe o resultado confirmado e apresente o conteúdo útil; pare somente quando o mandato ou uma decisão material exigir. Dentro de uma Parte já autorizada, avance uma microssequência por vez sem pedir nova confirmação apenas porque a anterior terminou. Não repare durante auditoria, não certifique o próprio reparo e não crie artefato editorial fora do mandato. A pessoa pode pular auditoria ou reauditoria e aprovar apenas alguns reparos sem criar estado, token ou trava adicional. Correção de payload, retry e releitura após conflito pertencem à etapa técnica em curso."
  }),
  Object.freeze({
    id: "authoring-brief",
  ...
  Object.freeze({
    ...
    text: "Compare fontes e objetivo, análise, snapshot, ResourceSet, blueprint, cards e manifesto por referências versionadas. Checks determinísticos localizam referências, autorizações, hashes e cobertura; auditoria semântica procura compressão, explicação insuficiente, prática desalinhada, ordem inadequada, representação imprópria e lacunas. Finding não autoriza reparo; a pessoa decide e a reauditoria relê o estado corrente. Conformidade não prova aprendizagem."
  }),
  Object.freeze({
