...
export const AUTHORING_SERVER_INSTRUCTIONS = [
  ...
  "Sem pré-requisito comprovado, fundamente antes de cobrar; dimensione e decomponha pela cobertura, pelas dependências, pelas dificuldades e pela progressão necessária, nunca por cota de cards.",
