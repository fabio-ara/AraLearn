...
async function mountPanel(page, { failFirstCreate = false, readOnly = false, admin = false } = {}) {
  await page.goto("/");
  await page.evaluate(async ({ userId, workspaceId, shouldFailFirstCreate, isReadOnly, isAdmin }) => {
