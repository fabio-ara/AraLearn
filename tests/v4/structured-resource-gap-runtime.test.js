...
const cards = {
  ...
  tree: commonCard("tree", "Árvore interativa", {
    ...
    variant: "filesystem",
    nodes: [
      { id: "root", label: "[[Diretorio17]]", parentId: null, entryType: "directory" },
      { id: "leaf", label: "[[Arquivo29::Arquivo29|Atalho31]]", parentId: "root", entryType: "file" }
    ]
  }),
  graph: commonCard("graph", "Grafo interativo", {
    ...
    edges: [
      { id: "edge-1", from: "a", to: "b", weight: "[[Peso29::Peso29|Peso31]]", directed: true }
    ]
  }),
