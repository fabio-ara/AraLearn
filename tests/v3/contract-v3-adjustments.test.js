...
test("choice resolve ids encontra a resposta correta pelo answer do bloco", () => {
...
test("choice resolve ids também respeita flags answer já normalizadas", () => {
  const correct = getCorrectExerciseOptionIds(
    [
      { id: "a", value: "Errada", answer: false },
      { id: "b", value: "Correta", answer: true },
      { id: "c", value: "Errada", answer: false }
    ],
    ""
  );
      ...
      cards: {
        ...
        items: {
          anyOf: [
            ...
            {
              type: "object",
              required: ["position", "resource", "question", "options", "answer"],
              properties: {
                position: { type: "integer" },
