...
Cada entrada conserva os nomes e a arquitetura do período em que a mudança foi
feita. Para compreender o produto vigente, comece pelo [mapa da
...
- o início de mapas extensos por Actions e MCP permite salvar primeiro o contexto e continuar por ramos, preservando os textos e o planejamento existente;
- os links retornados após salvar explicações abrem o conteúdo de cada microssequência, inclusive antes da produção de unidades;
- a explicação, os detalhes e os painéis de autoria conservam a largura de celular, agrupam as ações por ícones e distinguem o contexto autoral do conteúdo editável; revisar uma unidade abre sua declaração sem duplicar o conteúdo;
...
- explicações defensivas foram reescritas como relações verificáveis, preservando
  as distinções necessárias entre propriedades técnicas, avaliação educacional e
  evidência de pesquisa.

### Alterado

- a documentação passa a construir cada assunto desde o problema e as relações
  necessárias, inclusive nos capítulos técnicos e acadêmicos, antes de introduzir
  contratos ou terminologia especializada;
- textos narrativos apresentam hierarquias pelo alcance e usam poucos exemplos
  representativos; inventários completos permanecem nas referências em que cada
  item precisa ser consultado.
