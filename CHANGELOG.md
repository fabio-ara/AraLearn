...
- APK pública de release atualizada com o seed embarcado reorganizado de forma declarativa, `versionCode` maior para permitir atualização sobre a instalação anterior e a expansão de `Fundamentos` até a Aula 8.
