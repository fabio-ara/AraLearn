...
async function main() {
  ...
  console.log(
    `Corte enxuto validado em ${slimCutover.fileName}, ${copyOnWriteCutover.fileName} e ${artifactControl.fileName}: catálogo compartilhado, estado pessoal mínimo e autoria por artefatos privados.`
  );
}
