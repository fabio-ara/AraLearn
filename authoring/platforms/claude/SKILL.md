...
1. Liste e leia conteúdo existente.
2. Crie ou abra um workspace e leia sua revisão.
3. Registre a estrutura em lotes com `criarEstruturaNoWorkspace`.
4. Consulte o resource e use `salvarCardsNaMicrossequencia` em uma unidade por
...
7. Em Trilhas, estude sem publicar; fixe uma revisão para submissão ou distribua
