...
Quando houver conector autenticado, use a API como memória operacional e publique somente após validação integral. Um Project isolado não executa essa escrita. Sem conector remoto habilitado, conclua o ciclo por arquivos, monte o documento v3 final e deixe a importação para o AraLearn. Nunca peça nem use `service_role` do Supabase.
