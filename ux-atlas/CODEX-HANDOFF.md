...
- **Documentação:** `docs/principios-editoriais.md` e `docs/README.md`.
...
Os percursos principais devem ensinar, com linguagem simples e natural:

- o que é o AraLearn;
- como navegar;
- como estudar e retomar;
- como editar e usar Assistência por API;
- como criar, planejar e manter Cursos;
- como configurar Parâmetros e componentes;
- como trabalhar com Fontes/PDFs, Observações, auditoria, Variantes e Pesquisa;
- como compartilhar e retirar acesso;
- como excluir/limpar objetos sem confundir alcances;
- como usar Manutenção quando a pessoa possuir o papel administrativo.
...
- referências acadêmicas e normas usam fontes verificáveis e permanecem disponíveis em `referencias.md`/`referencias.bib`;
- detalhes técnicos e acadêmicos não são removidos para simplificar a entrada: ficam em documentos de aprofundamento claramente ligados a partir da camada didática.

Em #154, revise o corpus inteiro guiado por `docs/inventario-documentacao.md`; reescreva, consolide ou remova documentos correntes quando necessário. Não mantenha duas páginas concorrentes sobre o mesmo comportamento. Execute os auditores documentais existentes e corrija também problemas de clareza/coerência que a automação não detecta.
...
8. Documentação didática, técnica e acadêmica descreve a mesma versão do produto, sem bastidores.
9. `node ux-atlas/validate.mjs`, testes e auditores pertinentes passam.
10. Depois de #155, não iniciar #156–#168.