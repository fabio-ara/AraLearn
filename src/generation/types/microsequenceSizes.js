...
export function getMicrosequenceSize(size) {
  return listMicrosequenceSizes().find((item) => item.id === size) || null;
}

export function getMicrosequenceCardCount(size) {
  return getMicrosequenceSize(size)?.recommendedBatchCards || 0;
}
