...
const TYPES = [
  {
    ...
    baseResourceTypes: ["paragraph", "choice"],
    cardPlansBySize: {
      short: plans([
        ["anchor_context", "ancorar o contexto", ["paragraph"]],
        ["guided_practice", "guiar a primeira prática", ["paragraph", "choice"]],
        ["consolidate", "consolidar", ["choice", "paragraph"]]
      ]),
      medium: plans([
        ["anchor_context", "ancorar o contexto", ["paragraph"]],
        ["show_micro_example", "mostrar microexemplo", ["paragraph", "table", "code"]],
        ["guided_practice", "guiar a primeira prática", ["paragraph", "choice"]],
  ...
  },
  {
    ...
    cardPlansBySize: {
      ...
      medium: plans([
        ...
        ["show_minimal_case", "mostrar caso mínimo", ["paragraph", "table", "code"]],
        ["check_understanding", "checar entendimento", ["choice"]],
        ["consolidate", "consolidar", ["paragraph", "choice"]]
      ]),
      long: plans([
  ...
  },
  {
    ...
    cardPlansBySize: {
      short: plans([
        ...
        ["show_main_step", "mostrar a etapa principal", ["paragraph", "table", "code", "flow", "tree"]],
        ["check_understanding", "checar entendimento", ["choice"]]
      ]),
      medium: plans([
        ["situate_task", "situar a tarefa", ["paragraph"]],
        ["show_first_step", "mostrar a primeira etapa", ["paragraph", "table", "code", "flow", "tree"]],
        ["show_next_step", "mostrar a próxima etapa", ["paragraph", "table", "code", "flow", "tree"]],
        ["check_understanding", "checar entendimento", ["choice"]],
        ["consolidate", "consolidar", ["paragraph", "choice"]]
      ]),
      long: plans([
  ...
  },
  {
    ...
    cardPlansBySize: {
      short: plans([
        ...
        ["guided_gap", "propor a primeira prática", ["paragraph"]],
        ["check_and_consolidate", "checar e consolidar", ["choice", "paragraph"]]
      ]),
      medium: plans([
        ["situate_practice", "situar a prática", ["paragraph"]],
        ["show_minimal_reference", "mostrar referência mínima", ["paragraph", "table", "code"]],
        ["guided_gap", "propor a primeira prática", ["paragraph"]],
        ["check_understanding", "checar entendimento", ["choice"]],
        ["consolidate", "consolidar", ["paragraph", "choice"]]
      ]),
  ...
  },
  {
    ...
    cardPlansBySize: {
      short: plans([
        ...
        ["recover_detail", "recuperar um detalhe", ["paragraph", "choice"]],
        ["consolidate", "consolidar", ["choice", "paragraph"]]
      ]),
      medium: plans([
        ["recall_key_idea", "retomar a ideia-chave", ["paragraph"]],
        ["recover_first_detail", "recuperar um primeiro detalhe", ["paragraph"]],
        ["recover_second_detail", "recuperar um segundo detalhe", ["paragraph", "choice"]],
        ["check_understanding", "checar entendimento", ["choice"]],
  ...
  },
  {
    ...
    cardPlansBySize: {
      short: plans([
        ...
        ["show_rule_flow", "mostrar o fluxo principal", ["table", "flow", "paragraph"]],
        ["check_interpretation", "checar interpretação", ["choice"]]
      ]),
      medium: plans([
        ["situate_rule", "situar a regra", ["paragraph"]],
        ["show_main_condition", "mostrar a condição principal", ["paragraph", "table", "flow"]],
        ["show_exception_or_variation", "mostrar exceção ou variação", ["paragraph", "table", "flow"]],
        ["check_interpretation", "checar interpretação", ["choice"]],
        ["consolidate", "consolidar", ["paragraph"]]
      ]),
      long: plans([
  ...
  },
  {
    ...
    availableSizes: ["short", "medium"],
    baseResourceTypes: ["paragraph", "code", "choice"],
    cardPlansBySize: {
      short: plans([
        ["situate_command", "situar o comando", ["paragraph"]],
        ["show_minimal_use", "mostrar uso mínimo", ["code", "tree"]],
        ["check_function", "checar a função", ["choice"]]
      ]),
      medium: plans([
        ["situate_command", "situar o comando", ["paragraph"]],
        ["show_minimal_use", "mostrar uso mínimo", ["code", "tree"]],
        ["explain_critical_piece", "explicar a parte crítica", ["code", "paragraph", "tree"]],
        ["check_function", "checar a função", ["choice"]],
        ["consolidate", "consolidar", ["paragraph", "choice"]]
      ]),
      long: plans([
...
export function getMicrosequenceType(type) {
  return listMicrosequenceTypes().find((item) => item.id === type) || null;
}
