export function buildImprovePrompt(packet, reason = "") {
  return [
    ...
    "Use títulos curtos de aula, como 'Ideia central', 'Exemplo guiado', 'Complete o percurso' ou 'Retomada final'.",
    "Não escreva títulos como plano de autoria: evite 'Explicar...', 'Mostrar...', 'Pedir...', 'Variar...', 'Retomar...' quando eles descrevem a intenção do card.",
    "Não mantenha trechos como 'outro elemento', 'um detalhe lateral', 'Nesta etapa, Explicar que', 'Pedir que o estudante' ou marcações repetidas como '[[termo::termo|termo]]'.",
