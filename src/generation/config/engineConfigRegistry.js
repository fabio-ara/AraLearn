...
export function resolveEngineProfile(profileOrOverrides = {}, overrides = {}) {
  ...
  const inlineOverrides =
    profileOrOverrides && typeof profileOrOverrides === "object" && !Array.isArray(profileOrOverrides)
      ? profileOrOverrides
      : {};
  return mergeRecords(baseProfile, overrides && typeof overrides === "object" ? mergeRecords(inlineOverrides, overrides) : inlineOverrides);
}

export function getDidacticPolicyConfig(profileOrOverrides = {}, overrides = {}) {
  return structuredClone(resolveEngineProfile(profileOrOverrides, overrides).didacticPolicy || {});
}
