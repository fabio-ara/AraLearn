const MODEL_CAPABILITIES = Object.freeze({
  ...
  "deepseek-quality": freezeModel({ provider: "deepseek", model: "deepseek-quality", family: "deepseek", tier: "profile", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: false, supportsThinking: true, contextClass: "large" }),
  "deepseek-v4-pro": freezeModel({ provider: "deepseek", model: "deepseek-v4-pro", family: "deepseek", tier: "strong", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: false, supportsThinking: true, contextClass: "large" }),
  "deepseek-v4-flash": freezeModel({ provider: "deepseek", model: "deepseek-v4-flash", family: "deepseek", tier: "cheap", supportsJsonMode: true, supportsJsonSchema: false, supportsStrictJsonSchema: false, supportsThinking: false, contextClass: "medium" }),
