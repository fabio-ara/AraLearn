const MODEL_CAPABILITIES = Object.freeze({
  ...
  "deepseek-quality": freezeModel({ provider: "deepseek", model: "deepseek-quality", family: "deepseek", tier: "profile", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: true, supportsThinking: true, supportsToolUse: true, contextClass: "large" }),
  "deepseek-v4-pro": freezeModel({ provider: "deepseek", model: "deepseek-v4-pro", family: "deepseek", tier: "strong", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: true, supportsThinking: true, supportsToolUse: true, contextClass: "large" }),
  "deepseek-v4-flash": freezeModel({ provider: "deepseek", model: "deepseek-v4-flash", family: "deepseek", tier: "cheap", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: true, supportsThinking: false, supportsToolUse: true, contextClass: "medium" }),
  "deepseek:deepseek-v4-pro": freezeModel({ provider: "deepseek", model: "deepseek:deepseek-v4-pro", family: "deepseek", tier: "strong", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: true, supportsThinking: true, supportsToolUse: true, contextClass: "large" }),
  "deepseek:deepseek-v4-flash": freezeModel({ provider: "deepseek", model: "deepseek:deepseek-v4-flash", family: "deepseek", tier: "cheap", supportsJsonMode: true, supportsJsonSchema: true, supportsStrictJsonSchema: true, supportsThinking: false, supportsToolUse: true, contextClass: "medium" }),
