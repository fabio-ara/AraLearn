  ...
  render(data, options = {}) {
    return '<section class="runtime-block package-audio-tool"><p data-audio-configuration-status role="status">Preparando áudio…</p>' +
      ...
      '<ol class="package-audio-tracks">' + data.tracks.map(track =>
        ...
        `<div class="package-audio-timeline"><input type="range" data-audio-progress min="0" max="1" step="0.01" value="0" disabled aria-label="${escapePackageAttribute(`Posição em ${track.label}`)}"><span class="package-audio-time"><span data-audio-elapsed>0:00</span> / <span data-audio-duration>–:––</span></span></div>` +
