...
export const calculatorPackage = Object.freeze({
  ...
  render(data, options = {}) {
    ...
    return `<section class="runtime-block package-calculator"><h3>${renderPackageLiteral(data.title)}</h3>${data.prompt ? renderPackageProse(data.prompt) : ""}<form data-calculator-form><label for="${key}">Expressão<input id="${key}" data-calculator-input type="text" dir="ltr" maxlength="256" autocomplete="off" autocapitalize="off" spellcheck="false" value="${escapePackageAttribute(data.initialExpression || "")}"></label><label>Unidade dos ângulos<select data-calculator-angle><option value="radians"${data.angleUnit === "radians" ? " selected" : ""}>Radianos</option><option value="degrees"${data.angleUnit === "degrees" ? " selected" : ""}>Graus</option></select></label><div class="package-calculator-actions"><button class="icon-ghost" type="submit" aria-label="Calcular" title="Calcular"><svg class="home-tab-icon" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M5 9h14M5 15h14"/></svg></button><button class="icon-ghost" type="button" data-calculator-clear aria-label="Limpar" title="Limpar"><svg class="home-tab-icon" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="m4 14 8-9a2 2 0 0 1 3 0l5 5a2 2 0 0 1 0 3l-6 7H9l-5-5a1 1 0 0 1 0-1ZM9 9l9 9M14 20h7"/></svg></button></div><output data-calculator-output role="status" aria-live="polite" aria-atomic="true"></output></form><details class="package-calculator-limits"><summary>Operações e precisão</summary><dl><div><dt>Operadores</dt><dd><code>+ − × ÷ ^ ( )</code> · constantes <code>pi</code> e <code>e</code></dd></div><div><dt>Funções</dt><dd><code>abs, sqrt, ln, log, exp, sin, cos, tan</code> · <code>log</code> usa base 10.</dd></div><div><dt>Exemplos</dt><dd><code>2 × 3</code> · <code>sqrt(9)</code> · <code>2^3^2 = 512</code> · <code>−2^2 = −4</code></dd></div><div><dt>Precisão</dt><dd>Até 12 algarismos significativos. Use ponto ou vírgula decimal, sem separador de milhar.</dd></div></dl></details></section>`;
  },
