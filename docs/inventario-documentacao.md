...
O inventário relaciona os documentos públicos e a função de cada um no conjunto.
Para escolher um percurso de leitura por tarefa ou interesse, consulte o
...
| [`docs/configuracoes.md`](configuracoes.md) | preferências pessoais, conta e dados do dispositivo |
...
| [`docs/criar-cursos-pelo-chat.md`](criar-cursos-pelo-chat.md) | guia de autoria por conversa |
...
| Documento | Função e fonte principal |
| --- | --- |
| [`docs/principios-editoriais.md`](principios-editoriais.md) | critérios compartilhados para redação, revisão e contribuição documental |
...
de funcionamento acompanham as mudanças do produto; os registros históricos
identificam o período e a versão a que se referem.
