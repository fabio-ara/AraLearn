...
- preparar uma rodada limpa, uma rodada com achado factual aberto, uma proposta
  focal pronta para aplicar e um checkpoint que possa ser revertido; incluir
  uma Anotação retirada ainda como tombstone e outra cujo vínculo já foi limpo;
...
| 3. Reconhecer as sete áreas | diferencia Planejamento, Parâmetros, Fontes, Estrutura, Inspeção, Auditoria e correções e Pessoas pelo propósito | interpretações erradas de ícones, rótulos ou ordem |
...
| 14. Encontrar uma rodada limpa | abre Achados, filtra pela Unidade e encontra a execução sem achado; no detalhe compreende checks e evidências | rodada limpa invisível, lista confundida com achados ou evidência incompreensível |
...
| 18. Reverter pelo checkpoint | reconhece o estado anterior/posterior, confirma rollback e percebe que histórico permanece | expectativa de apagar histórico ou restaurar quando o conteúdo já mudou |
| 19. Compreender privacidade e conexão | vê Anotação retirada indisponível, vínculo limpo ausente e nenhum texto/pessoa copiado; offline, entende que auditoria não possui fila | identidade exposta, link ainda ativo, impressão de perda do achado ou expectativa de aplicar offline |
| 20. Compreender legado não resolvido | reconhece que faltam metadados, não espera link inventado e resolve mantendo a mesma referência | tentativa de criar duplicata, “corrigir” a identidade ou presumir Fonte completa |
...
| 22. Voltar entre Estudo e Autoria | retorna ao mesmo Curso/contexto sem confundir autoridade de leitura e edição | perda de contexto, atalhos ocultos ou navegação redundante |
...
9. “O que o rollback restaura e o que ele preserva como histórico?”
10. “Que palavras, botões ou telas pareceram técnicas demais?”
