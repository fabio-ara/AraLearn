...
| “Peça à assistência do aplicativo uma alteração focal e confira antes de aceitar.” | escolhe o provider sem lidar com endpoint, distingue proposta de aplicação e mantém o Curso utilizável em falha ou cota | escopo mínimo sem identidades internas, proposta corrente e chave efêmera ausente da persistência |
| “Discuta uma mudança que envolva mais de um componente e confira a proposta antes de salvar.” | entende conversa, revisão da proposta, aceite, aplicação ao rascunho e gravação como decisões separadas | contexto delimitado, contratos descobertos, renderer real e conteúdo preservado diante de proposta inválida |
