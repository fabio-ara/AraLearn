...
| P2 | Quando condições, exigências e dificuldades previstas são explicitadas, respostas locais podem tornar a progressão mais coerente com o público e o objetivo sem reduzir profundidade. | `src/authoring/pedagogicalBlueprint.js`; `authoring/core/quality.md` | validação dos vínculos condição–exigência–dificuldade–resposta, dependências, cobertura e rastreabilidade entre diagnóstico, plano e cards | julgamento de especialistas e tarefas de explicação e aplicação sob condições e conhecimentos prévios delimitados | perguntar somente diante de lacuna material; dividir, recompor, aprofundar ou trocar a resposta quando houver promessa ausente, salto, condensação, fragmentação, prática sem base, representação inadequada ou meio externo indisponível |
