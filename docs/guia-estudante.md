...
No modo automático, o aplicativo procura realizar essa troca quando há conexão. No manual, suas ações de estudo continuam guardadas localmente; use o ícone da nuvem quando quiser enviá-las e procurar atualizações. A nuvem indica se há algo pendente, em andamento ou com falha. Salvar uma edição autoral e enviar uma observação continuam sendo ações explícitas nos dois modos.
...
Dentro do percurso também há reinícios delimitados. A confirmação mostra o ponto da estrutura a partir do qual o progresso será limpo.

## Editar ou usar Assistência por IA

Se você é proprietário do curso, também encontra ações de autoria durante o estudo. **Editar** abre diretamente os campos disponíveis. **Assistência por IA** permite discutir uma proposta e comparar uma prévia antes de aplicá-la ao rascunho. O [guia da pessoa autora](guia-professor-autor.md#observar-e-corrigir) explica como inspecionar e corrigir o curso; [Uso do aplicativo](uso-do-app.md#editar-uma-unidade-no-próprio-conteúdo) apresenta os controles.

## Cuidar da conta e dos dados do dispositivo

**Sair** encerra a sessão e pode manter a cópia local. **Remover dados deste dispositivo** apaga a cópia da conta ativa; **Sair e remover dados deste dispositivo** realiza os dois efeitos. **Excluir conta** remove de forma irreversível a conta e seus cursos próprios. Antes de qualquer limpeza, confira o que ainda aguarda sincronização. As [operações de saída e exclusão](uso-do-app.md#sair) apresentam os demais efeitos e as precauções necessárias, especialmente num aparelho compartilhado.

## Como interpretar o estado de estudo

O progresso mostra por onde você passou; as marcas **Rever** ajudam a escolher o que retomar. Esses registros servem à continuidade do estudo. Avaliar aprendizagem exige outras evidências, como conseguir explicar o assunto, resolver uma tarefa e aplicar o conhecimento em outra situação. Veja [Estado de estudo não punitivo](estado-de-estudo-nao-punitivo.md) para conhecer o que fica guardado e como interpretar esses dados.
