...
- acesso direto concede somente Estudo no Curso original; a cópia pessoal
  candidata da #149 é criada exclusivamente pela aplicação e só depois passa a
  ser um Curso próprio;
